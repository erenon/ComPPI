...
initHistogram = function() {
	var dataPath = $('#histogram-path').attr('content'),
		createChart = function(data, targetIdx) {
			//init BarChart
	...
	.error(function() {
		$('.interaction-histogram-container').after('<div class="message message-notice">Failed to load chart data</div>');
