...
var Log = {
    ...
    write : function(text) {
        if (!this.elem)
            this.elem = document.getElementById('loctree-visualization-log');
...
function init() {
    ...
    var container = 'loctree-visualization';
    ...
    containerStyle.width = (viewport.width - 40) + 'px';
    containerStyle.height = (viewport.height - 320) + 'px';

    /**
     * @see onBeforeCompute
     * @see onAfterCompute
     */
    var lastComputedNode;
    ...
    var st = new $jit.ST({
        ...
        /*
         * request : function(nodeId, level, onComplete) { var ans =
         * getTree(nodeId, level); onComplete.onComplete(nodeId, ans); },
         */

        onBeforeCompute : function(node) {
            Log.write("loading " + node.data.humanReadable);
            lastComputedNode = node;
        },

        onAfterCompute : function(node) {
            Log.write(lastComputedNode.data.humanReadable);
        },
